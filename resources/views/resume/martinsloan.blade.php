...
<div class="container" id="resume">
            ...
            <section id="basics">
                <div class="contact">
                    <div class="website">
                        ...
                        <a href="http://karma-tek.com">http://karma-tek.com</a>
                    </div>
                    <div class="email">
    ...
    <section id="work" class="row">
        ...
        <div class="col-sm-8">
            <div class="item">
                <h3 class="name">
                    Karma-Tek Consulting
                </h3>
                <div class="position">
                    <p class="lead">Consultant</p>
                </div>
                <div class="date">
            ...
            <div class="item">
                ...
                <div class="position">
                    <p class="lead">Senior Unified Communications Engineer</p>
                </div>
                <div class="date">
					<span class="startDate">
						2011-03-01
                ...
                <ul class="highlights">
                    <li>Developed custom tool set to migrate data from a legacy DMS 100 system to Cisco UC, provisioning 20k users via automation scripts.</li>
                    <li>Developed a systems integration tool set that served as the interface between the customer UC systems, Oracle database and asset management software.</li>
                    <li>Developed a Cisco Jabber contact photo resolution tool to normalize URL requests between data sources, serving the entire mega cluster user base.</li>
                </ul>
            </div>
            <div class="item">
                <h3 class="name">
                ...
                <div class="position">
                    <p class="lead">Senior NOC Engineer</p>
                </div>
                <div class="date">
					<span class="startDate">
						2010-08-01
            ...
            <div class="item">
                ...
                <div class="position">
                    <p class="lead">Tier 1 Supervisor</p>
                </div>
                <div class="date">
					<span class="startDate">
						2008-03-01
                ...
                <ul class="highlights">
                    ...
                    <li>Maintained employee work schedule and ensured coverage during peak hours. </li>
                    <li>Resolved customer complaints and concerns.</li>
    ...
    <section id="education" class="row">
        ...
        <div class="col-sm-8">
            <div class="item">
                <h3 class="institution">Mount Aloysius College </h3>
                <div class="area">
                ...
                <ul class="courses">
                    <li>CS104B - Visual Basic</li>
                    <li>CS120 - Introduction to Networking</li>
                    <li>CS228 - Client/Server Operating Systems</li>
                    <li>CS205A - Integrated Business Applications</li>
                    <li>CS226 - CS System Design</li>
                    <li>CS206B - Database Management Systems</li>
                </ul>
            </div>
        </div>
    </section>
    ...
    <section id="awards" class="row">
        ...
        <div class="col-sm-8">
            ...
            <div class="item">
                <h3 class="title">Cisco Certified Internetwork Expert (Collaboration)</h3>
                <div class="awarder">
                    <p class="lead">Cisco Systems</p>
                </div>
                <div class="date">
                    2013-10-01
                </div>
        ...
        <div class="col-sm-8">
            <div class="item">
                ...
                <ul class="keywords">
                    ...
                    <li>Cisco Contact Center Express</li>
                    <li>Cisco IM and Presence</li>
                    <li>SIP | H323 | SCCP | MGCP</li>
                    <li>Voice Gateways | SRST</li>
                    <li>Cisco Jabber</li>
                    <li>LAN/WAN   QoS</li>
                    <li>C-Series | B-Series | MCS</li>
                    <li>Asterisk Open Source PBX</li>
                    <li>Twilio - Cloud Communications</li>
                </ul>
            </div>
            <div class="item">
                <h3 class="name">Amazon Web Services</h3>
                <ul class="keywords">
                    <li>DynamoDB</li>
            ...
            <div class="item">
                <h3 class="name">Web Development (Back End)</h3>
                <ul class="keywords">
                    <li>PHP | Laravel</li>
                    <li>Python | Django</li>
            ...
            <div class="item">
                <h3 class="name">Web Development (Front End)</h3>
                <ul class="keywords">
                    <li>Bootstrap 3</li>
                    <li>Vue.js</li>
                    <li>Angular.js</li>
            ...
            <div class="item">
                <h3 class="name">Developer Tools &amp; Services</h3>
                <ul class="keywords">
                    <li>Laravel Forge</li>
                    <li>Heroku</li>
                    ...
                    <li>Mailgun</li>
                    <li>Bower</li>
                    <li>Laravel Elixer</li>
                    <li>Package Management | composer / npm / pip</li>
                </ul>
            </div>
            <div class="item">
                <h3 class="name">Web Development (Database)</h3>
                <ul class="keywords">
                    <li>AWS RDS</li>
                    <li>MySQL</li>
                    <li>SQLite</li>
            ...
            <div class="item">
                <h3 class="name">Operating Systems</h3>
                <ul class="keywords">
                    <li>Linux | Ubuntu / Red Hat / CentOS</li>
                    <li>OS X</li>
                    <li>Cisco IOS</li>
            ...
            <div class="item">
                <h3 class="name">Virtualization Technologies</h3>
                <ul class="keywords">
                    <li>VMWare</li>
                    <li>Virtualbox</li>
                    <li>Vagrant</li>
